...
export default function page() {
  const line1 = `I am so sorry for everthing, thoda gaana sun le mood theek ho jayega.`;
  return (
    <>
        ...
        <div className="flex justify-center items-center ">
          <div className="w-full mx-auto md:w-3/4 h-full md:h-1/2 my-9 ">
            <iframe
              ...
              src="https://open.spotify.com/embed/playlist/0uyEPnKfRwO6cbCJkWtfFb?utm_source=generator"
              width="100%"
              height="400"
              allowFullScreen
              frameBorder="0"
